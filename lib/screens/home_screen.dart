...
Controllers().userPutData.Fresh_count =value['Fresh_count'] ;
Controllers().userPutData.Pending_count =value['Pending_count'] ;
Controllers().userPutData.History_count =value['History_count'] ;

  }
  print(Controllers().userFetchData.Pending_count);
});
}
        ...
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text('${Controllers().userFetchData.name}',style:  TextStyle(fontSize: 16.sp,fontWeight: FontWeight.w700),),
              ],
            ),
          ),
          Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              ...
              Obx( ()=>
                 HomeItem(heading: 'Pending', image: 'assets/ic_pending.png',title: 'Pending case',number: Controllers().userFetchData.Pending_count as RxInt,)),
            ],
          ),
